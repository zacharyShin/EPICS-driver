...
/* Generated from ../O.Common/pfcu.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devaoStream, *pvar_dset_asynAoInt32,
    ...
    *pvar_dset_devlongoutStream, *pvar_dset_asynLoInt32,
    ...
    *pvar_dset_devSiEnviron, *pvar_dset_devstringinStream,
    ...
    *pvar_dset_devstringoutStream, *pvar_dset_asynSoOctetWrite,
...
static const char * const deviceSupportNames[] = {
    ...
    "devAoSoft", "devAoSoftRaw", "devAoSoftCallback", "devaoStream",
    "asynAoInt32", "asynAoFloat64", "asynRecordDevice", "devBiSoft",
    "devBiSoftRaw", "devBiSoftCallback", "devBiDbState", "devbiStream",
    "asynBiInt32", "asynBiUInt32Digital", "devBoSoft", "devBoSoftRaw",
    "devBoSoftCallback", "devBoGeneralTime", "devBoDbState",
    "devboStream", "asynBoInt32", "asynBoUInt32Digital", "devCalcoutSoft",
    "devCalcoutSoftCallback", "devcalcoutStream", "devEventSoft",
    "devHistogramSoft", "devLiSoft", "devLiSoftCallback",
    "devLiGeneralTime", "devlonginStream", "asynLiInt32",
    "asynLiUInt32Digital", "devLoSoft", "devLoSoftCallback",
    ...
    "devmbbiStream", "asynMbbiInt32", "asynMbbiUInt32Digital",
    ...
    "asynSoOctetWrite", "devSASoft", "devWfSoft", "devwaveformStream",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_asynMbboUInt32Digital, pvar_dset_devMbboDirectSoft,
    pvar_dset_devMbboDirectSoftRaw, pvar_dset_devMbboDirectSoftCallback,
    pvar_dset_devmbboDirectStream, pvar_dset_asynMbboDirectUInt32Digital,
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_dbndInitialize, pvar_func_drvAsynSerialPortRegisterCommands,
...
int pfcu_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/guest/epics/pfcu";
...
/* pfcu_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"pfcu_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    pfcu_registerRecordDeviceDriver(*iocshPpdbbase);
}
